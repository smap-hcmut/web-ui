  ...
  return (
    <div className="min-h-screen relative bg-amber-50 dark:bg-gray-950 overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        >
          <h2 className="text-3xl font-black text-center mb-2 text-gray-900 dark:text-white">{t('register.title')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-5 h-5 border-2 border-amber-300/60 dark:border-white/20 rounded focus:ring-2 focus:ring-gray-900 dark:focus:ring-white bg-white/80 dark:bg-gray-900/80 text-gray-900 dark:text-white accent-gray-900 dark:accent-white"
                required
              />
              <label htmlFor="terms" className="text-sm text-gray-700 dark:text-gray-300">
                {t('register.agreeToTerms')}{' '}
                <Link href="/terms" className="font-semibold text-gray-900 dark:text-white hover:underline underline-offset-2">
                  {t('register.termsLink')}
                </Link>
                {' '}{t('register.and')}{' '}
                <Link href="/privacy" className="font-semibold text-gray-900 dark:text-white hover:underline underline-offset-2">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white/80 dark:bg-gray-800/80 border border-amber-300/60 dark:border-white/20 rounded-lg font-semibold hover:bg-white dark:hover:bg-gray-800 transition-all duration-200 shadow-lg">
              ...
              <span className="text-sm text-gray-900 dark:text-white">Apple</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-amber-300/60 dark:border-white/20 rounded-2xl shadow-lg">
              ...
              <h3 className="text-lg font-black mb-2 text-gray-900 dark:text-white">
                {t('register.benefits.benefit1.title')}
              </h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t('register.benefits.benefit1.description')}
              </p>
            </div>
            ...
            <div className="p-6 bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-amber-300/60 dark:border-white/20 rounded-2xl shadow-lg">
              ...
              <h3 className="text-lg font-black mb-2 text-gray-900 dark:text-white">
                {t('register.benefits.benefit2.title')}
              </h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t('register.benefits.benefit2.description')}
              </p>
            </div>
            ...
            <div className="p-6 bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-amber-300/60 dark:border-white/20 rounded-2xl shadow-lg">
              ...
              <h3 className="text-lg font-black mb-2 text-gray-900 dark:text-white">
                {t('register.benefits.benefit3.title')}
              </h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t('register.benefits.benefit3.description')}
              </p>
            </div>
          </div>
        </motion.div>
